        ...
        <div className="thanks-inner">
          ...
          <div className="next-steps">
            ...
            <ol>
              ...
              <li><strong>Return it to us</strong> — email the signed packet to <strong>mibloomsdmv@gmail.com</strong> to secure your date.</li>
            </ol>
            <a className="packet-download" href="/miblooms_co_welcome_packet.pdf" download>
